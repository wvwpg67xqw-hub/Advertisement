...
export async function initDatabase() {
  const tables = [
    `CREATE TABLE IF NOT EXISTS guilds (
      ...
      leveling_enabled             TINYINT(1) DEFAULT 1,
  ...
  const migrations = [
    ...
    `ALTER TABLE guilds ADD COLUMN IF NOT EXISTS level_xp_channel_id VARCHAR(20)`,
    `ALTER TABLE guilds ADD COLUMN IF NOT EXISTS leveling_enabled TINYINT(1) DEFAULT 1`,
    ...
    `ALTER TABLE guilds ADD COLUMN IF NOT EXISTS hub_mod_role_id VARCHAR(20)`,
    `ALTER TABLE guilds ADD COLUMN IF NOT EXISTS hub_team_lead_role_id VARCHAR(20)`,
    `ALTER TABLE guilds ADD COLUMN IF NOT EXISTS hub_admin_role_id VARCHAR(20)`,
