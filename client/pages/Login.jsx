...
export default function Login() {
  ...
  const appealErrors = ['blacklisted'];
  ...
  if (error === 'blacklisted') {
    return (
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 420, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
          <div style={{ fontSize: 56 }}>🚫</div>
          <h1 style={{ fontSize: 26, fontWeight: 700, marginBottom: 8 }}>Account Banned</h1>
